        ...
        while(scanf("%d", &choice) == 1 && point != 0)
        {
            switch(choice)  //Система распределения основных навыко
            {
                case 1:  //Повышение интелекта на 1
                  /*stat[0]++;
                  point--;
                  if(stat[0] > 10)  //Ограничитель до 10, ибо это максимальный показатель
                  {
                      stat[0]--;
                      point++;
                  }*/
                ...
                case 2:  //Повышение силы на 1
                  stat[1]++;
                  point--;
                  if(stat[1] > 10)  //Ограничитель до 10, ибо это максимальный показатель
                  {
                      stat[1]--;
                      point++;
                  }
                ...
                case 3:  //Повышение ловкости на 1
                  stat[2]++;
                  point--;
                  if(stat[2] > 10)  //Ограничитель до 10, ибо это максимальный показатель
                  {
                      stat[2]--;
                      point++;
                  }
                ...
                case 4:  //Повышение эмпатии на 1
                  stat[3]++;
                  point--;
                  if(stat[3] > 10)  //Ограничитель до 10, ибо это максимальный показатель
                  {
                      stat[3]--;
                      point++;
                  }
                ...
                case 5:  //Повышение восприятия на 1
                  stat[4]++;
                  point--;
                  if(stat[4] > 10)  //Ограничитель до 10, ибо это максимальный показатель
                  {
                      stat[4]--;
                      point++;
                  }
